          ...
          <tr>
            {[1, 2, 3, 4, 5, 6, 7].map((day) => (
              <td className="box-border" key={day}>
                <button
                  disabled={day === 4}
                  className="not:disa aspect-square w-full rounded-sm bg-gray-600 text-center  transition-colors hover:bg-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-100 focus:ring-offset-1 disabled:pointer-events-none disabled:bg-transparent"
                >
                  {day}
                </button>
              </td>
